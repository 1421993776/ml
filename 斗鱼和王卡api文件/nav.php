<div class="sile" >
		...
		<link rel="stylesheet" href="css/alert_html.css" />
<?php
...
$section[] =	["name"=>"主页状态","item"=>"admin.php","icon"=>"icon-dashboard"];
$section[] =	["name"=>"用户管理","item"=>[
					["name"=>"批量添加账号","item"=>"user_create.php","icon"=>""],
					["name"=>"上次添加账户","item"=>"lastkm/user.php","icon"=>""],
					["name"=>"添加账号","item"=>"user_add.php","icon"=>""],
					["name"=>"账号列表","item"=>"user_list.php","icon"=>""],
					["name"=>"在线用户","item"=>"online.php","icon"=>""]
				],"icon"=>"icon-user"];
$section[] =	["name"=>"免流云端","item"=>[
					["name"=>"证书管理","item"=>"zs.php","icon"=>""],
					["name"=>"线路列表","item"=>"line_list.php","icon"=>""],
					["name"=>"添加线路","item"=>"line_add.php","icon"=>""],
					["name"=>"分类管理","item"=>"cat_add.php","icon"=>""]
				],"icon"=>"icon-reorder"];
$section[] =	["name"=>"校园云端","item"=>[
					["name"=>"证书管理","item"=>"zs.php","icon"=>""],
					["name"=>"线路列表","item"=>"new_line_list.php","icon"=>""],
					["name"=>"添加线路","item"=>"new_line_add.php","icon"=>""],
					["name"=>"分类管理","item"=>"new_cat_add.php","icon"=>""]
				],"icon"=>"icon-reorder"];
$section[] =	["name"=>"套餐管理","item"=>[
					["name"=>"套餐管理","item"=>"list_tc.php","icon"=>""],
					["name"=>"添加套餐","item"=>"add_tc.php","icon"=>""],
...
$section[] =	["name"=>"接口管理","item"=>[
					//["name"=>"APP生成","item"=>"create_app.php","icon"=>""],
					["name"=>"线路接口","item"=>"line_api.php","icon"=>""],
					["name"=>"APP设置","item"=>"qq_admin.php","icon"=>""],
					["name"=>"升级与推送","item"=>"AdminShengji.php","icon"=>""]
				],"icon"=>"icon-group"];
$section[] =	["name"=>"加盟管理","item"=>[
					["name"=>"添加等级","item"=>"type_add.php","icon"=>""],
					["name"=>"等级列表","item"=>"type_list.php","icon"=>""],
					["name"=>"加盟注册","item"=>"dl_add.php","icon"=>""],
					["name"=>"加盟列表","item"=>"dl_list.php","icon"=>""]
				],"icon"=>"icon-tags"];
...
<div class="content-box">
		...
		<div class="main-top">
			<div>
				...
				<div class="nav-right hidden-xs">
					<a href="mysql.php" class="btn btn-success"><i class="icon-hdd"></i>&nbsp;&nbsp;数据备份</a>
					<a href="line_list.php" class="btn btn-warning"><i class="icon-reorder"></i>&nbsp;&nbsp;线路管理</a>
					<a href="login.php?act=logout" class="btn btn-danger"><i class="icon-signout"></i>&nbsp;&nbsp;退出账号</a>
				</div>
	...
	<div class="box-title">
		<i class="icon-dashboard"></i>&nbsp;Administrator&nbsp;&nbsp;<i class=" icon-angle-right"></i>&nbsp;&nbsp;<?=$nav_name?>
	</div>
